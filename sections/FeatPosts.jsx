...
import { getFeatPosts } from "../services/index";
import {FeatPostCard} from '../components/zindex';
...
const FeatPosts = () => {
  const [featuredPost, setFeatPosts] = useState([])
    ...
    <div className="mb-8 container mx-auto">
      ...
      >
        {dataLoaded && featuredPost.map((post, index) => (
          <FeatPostCard key={index} post={post}/>
        ))}
      </Carousel>
    </div>
  )
